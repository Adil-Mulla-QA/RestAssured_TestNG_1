...
import Request_Repository.Data_Provider;
import io.restassured.path.json.JsonPath;

public class Post_TC6_Data_Provider extends API_Common_Methods {
	 ...
	 public static void TestSetup() {
		 ...
		 log_dir = Directory.Create_Log_Directory("Data_Provider_2");
		 Endpoint = Post_EP.Endpoint();					
	 }
	 
	// Declare Data Provider CLass Name Which Provides Data
	
	@Test(dataProvider = "post_requestBody", dataProviderClass = Data_Provider.class)
	public static void Executor(String name, String job) throws IOException {		
	...
	public static void Test_TearDown() throws IOException {
		String TestClassName = Post_TC6_Data_Provider.class.getName();
