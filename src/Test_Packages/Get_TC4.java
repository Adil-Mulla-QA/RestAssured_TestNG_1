...
public class Get_TC4 {
	 ...
	 public static void TestSetup() {
		 ...
		 log_dir = Directory.Create_Log_Directory("Get_TC4");
	...
	public static void Validator(String ResponseBody) {
		...
		String res_Id = jspRes.getString("data[5].id");
		String res_Email  = jspRes.getString("data[5].email");
		String res_FirstName = jspRes.getString("data[5].first_name");
		String res_LastName  = jspRes.getString("data[5].last_name");
		String res_Avatar  = jspRes.getString("data[5].avatar");
		// Validate ResponseBody by Using TestNG
		
		Assert.assertNotNull(res_Id);
		
		Assert.assertEquals(res_Id, "12");
		Assert.assertEquals(res_Email, "rachel.howell@reqres.in");
		Assert.assertEquals(res_FirstName, "Rachel");		
		Assert.assertEquals(res_LastName, "Howell");
	...
	public static void Test_TearDown() throws IOException {
		String TestClassName = Get_TC4.class.getName();
